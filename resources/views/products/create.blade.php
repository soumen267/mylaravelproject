                        ...
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control @error ('category_id') is-invalid @enderror" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="originalprice" class="form-control @error ('originalprice') is-invalid @enderror" value="{{ old('originalprice') }}"
