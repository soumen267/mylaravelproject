                        ...
                        <div class="product-details-img">
                            <div class="product-thumb">
                                ...
                                <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                    <a data-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-zoom-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{ asset('storage/images/products/'.$getProduct['image']) }}" alt="" />
                                    </a>
                                    <a data-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-zoom-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{ asset('storage/images/products/'.$getProduct['image']) }}" alt="" />
                                    </a>
                                    <a data-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-zoom-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{ asset('storage/images/products/'.$getProduct['image']) }}" alt="" />
                                    </a>
                                    <a data-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-zoom-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{ asset('storage/images/products/'.$getProduct['image']) }}" alt="" />
                                    </a>
                                    <a data-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-zoom-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" class="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{ asset('storage/images/products/'.$getProduct['image']) }}" alt="" />
                                    </a>
                                    <a data-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-zoom-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" class="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{ asset('storage/images/products/'.$getProduct['image']) }}" alt="" />
                            ...
                            <div class="zoompro-wrap product-zoom-right pl-20">
                                <div class="zoompro-span">
                                    <img class="zoompro blur-up lazyload" data-zoom-image="{{ asset('storage/images/products/'.$getProduct['image']) }}" alt="" src="{{ asset('storage/images/products/'.$getProduct['image']) }}"/>
                                </div>
                                ...
                                <div class="product-buttons">
                                    ...
                                    <a href="javascript:void(0)" class="btn prlightbox" title="Zoom"><i class="icon anm anm-expand-l-arrows" aria-hidden="true"></i></a>
                                </div>
                            </div>
                            @if ($getProduct['image'])
                            <div class="lightboximages">
                                <a href="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-size="1462x2048"></a>
                                <a href="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-size="1462x2048"></a>
                                <a href="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-size="1462x2048"></a>
                                <a href="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-size="1462x2048"></a>
                                <a href="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-size="1462x2048"></a>
                                <a href="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-size="1462x2048"></a>
                                <a href="{{ asset('storage/images/products/'.$getProduct['image']) }}" data-size="731x1024"></a>
                            </div>
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product-single__meta">
                                ...
                                <div class="product-nav clearfix">					
                                    <a href="javascript:void(0)" class="next" title="Next"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                </div>
                                <div class="prInfoRow">
                                    <div class="product-stock"> <span class="instock ">In Stock</span> <span class="outstock hide">Unavailable</span> </div>
                                    <div class="product-sku">SKU: <span class="variant-sku">{{ $getProduct['sku'] }}</span></div>
                                    {{-- <div class="product-review"><a class="reviewLink" href="#tab2"><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star-o"></i><i class="font-13 fa fa-star-o"></i><span class="spr-badge-caption">6 reviews</span></a></div> --}}
                                </div>
                                <p class="product-single__price product-single__price-product-template">
                                    <span class="visually-hidden">Regular price</span>
                                    <s id="ComparePrice-product-template"><span class="money">${{ number_format($getProduct['originalprice'],2) }}</span></s>
                                    <span class="product-price__price product-price__price-product-template product-price__sale product-price__sale--single">
                                        <span id="ProductPrice-product-template"><span class="money">${{ number_format($getProduct['price'],2) }}</span></span>
                                    </span>
                                    <span class="discount-badge"> <span class="devider">|</span>&nbsp;
                                    @php
                                        $savePrice = $getProduct['originalprice'] - $getProduct['price'];
                                        $getPercent = ($savePrice / $getProduct['originalprice']) * 100;
                                    @endphp
                                        <span>You Save</span>
                                        ...
                                        <span class="off">(<span>{{ ceil($getPercent) }}</span>%)</span>
                                    </span>  
                                </p>
                             ...
                             @csrf   
                                ...
                                <div class="product-action clearfix">
                                    ...
                                    <div class="shopify-payment-button" data-shopify="payment-button">
                                        <button type="button" class="shopify-payment-button__button shopify-payment-button__button--unbranded buy-now">Buy it now</button>
                                    </div>
                                </div>
                                <!-- End Product Action -->
                            </form>
                            ...
                            @php
                                $fromdate = \Carbon\Carbon::now()->addDays(3)->format('l, M d Y');
                                $todate = \Carbon\Carbon::now()->addDays(5)->format('l, M d Y');
                                //dd($date);
                            @endphp    
                            ...
                            <p class="shippingMsg"><i class="fa fa-clock-o" aria-hidden="true"></i> ESTIMATED DELIVERY BETWEEN <b id="fromDate">{{ $fromdate }}{{-- Wed.May1 --}}</b> and <b id="toDate"> {{ $todate }}</b>.</p>
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="javascript:void(0)">
                                <!-- image -->
                                <img class="primary blur-up lazyload" data-src="{{ asset('storage/images/products/'.$item['image']) }}" src="{{ asset('storage/images/products/'.$item['image']) }}" alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="{{ asset('storage/images/products/'.$item['image']) }}" src="{{ asset('storage/images/products/'.$item['image']) }}" alt="image" title="product">
                                <!-- End hover image -->
                                <!-- product label -->
                                @php
                                 $savePrice = $item['originalprice'] - $item['price'];
                                 $getPercent = ($savePrice / $item['originalprice']) * 100;
                                @endphp
                            ...
                            {{-- <div class="button-set">
                                <a href="javascript:void(0)" title="Quick View" class="quick-view" tabindex="0">
                        ...
                        <div class="product-details text-center">
                            ...
                            <div class="product-price">
                                <span class="old-price">${{ number_format($item->originalprice,2) ?? ''}}</span>
                            ...
                            <!-- Variant -->
                            <ul class="swatches">
                                <li class="swatch medium rounded"><img src="{{ asset('storage/images/products/'.$item['image']) }}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{ asset('storage/images/products/'.$item['image']) }}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{ asset('storage/images/products/'.$item['image']) }}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{ asset('storage/images/products/'.$item['image']) }}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{ asset('storage/images/products/'.$item['image']) }}" alt="image" /></li>
...
$(".product-form__cart-submit").on("click", function(e){
    ...
    let qty = $(this).closest("#wrapQtyBtn").find(".product-form__input qty").val();
    $.ajax({
        type: "POST",
