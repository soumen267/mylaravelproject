...
<head>
    ...
    <title>403 Custom Error Page Example</title>
<style>
html {
...
<body>
    <div class="maincontainer">
      ...
      <div class="errortext">
        <a href="/" class="" style="text-decoration: none; color:black; background-color: white">This area is forbidden. Turn back now!</a>
    </div>
</body>
</html>